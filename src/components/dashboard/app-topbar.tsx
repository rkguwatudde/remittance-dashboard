...
export function AppTopbar({ onOpenMobileNav }: AppTopbarProps) {
  ...
  return (
    <header className="sticky top-0 z-40 flex h-14 items-center justify-between gap-3 border-b border-border bg-surface/80 px-4 backdrop-blur-md sm:gap-4 md:px-6">
